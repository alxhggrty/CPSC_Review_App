...
$("#nameDropdown").val(),
    ...
    <li class='active'><a href='ProcessedPotentialViolations.php'>Processed Potential Violations</a></li>
      ...
      <div style="left-margin:auto;right-margin:auto;display:block;width:850px;">
          ...
          <table style="text-align:center;left-margin:auto;right-margin:auto;display:block;">
      		  <tr>
      		    <td>Product Name:</td>
      		    <td><?php
              $sql="select * FROM dispute, potential_violation, recall where potential_violation.Dispute_Id=dispute.Dispute_Id
               and potential_violation.Recall_Id=recall.Recall_Id and potential_violation.Recall_Number=recall.Recall_Number
               group by Potential_Violation_URL
               ORDER BY Recall_Product_Name ASC;";
